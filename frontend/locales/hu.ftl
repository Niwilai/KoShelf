...
collections-empty = Még nincsenek gyűjtemények
...
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Jelenleg: oldalszám szerint növekvő
    .page-descending = { sort-order.aria-label-toggle } - Jelenleg: oldalszám szerint csökkenő
previous-month =
...
notes-book-search-placeholder = Könyvek keresése…
