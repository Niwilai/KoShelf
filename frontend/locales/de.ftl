...
estimated-time-left = Restzeit ca.
...
library-sort =
    .last-opened = Sortierung: Zuletzt geöffnet
    .alphabetical = Sortierung: A–Z
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Aktuell: Seitenzahl aufsteigend
    .page-descending = { sort-order.aria-label-toggle } - Aktuell: Seitenzahl absteigend
previous-month =
...
notes-book-search-placeholder = Bücher suchen…
