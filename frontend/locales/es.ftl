...
estimated-time-left = Tiempo restante
...
error-state =
    ...
    .crash-description = Ocurrió un error inesperado al renderizar esta página.
...
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Actual: Número de página ascendente
    .page-descending = { sort-order.aria-label-toggle } - Actual: Número de página descendente
previous-month =
...
# -----------------------------------
all-notes = Notas
notes-search-placeholder = Buscar resaltados, notas, libros...
notes-book-filter = Filtrar por libro
notes-book-search-placeholder = Buscar libros…
notes-empty = No se encontraron anotaciones
notes-empty-hint = Los resaltados y notas que agregues en KOReader aparecerán aquí.

page-activity = Actividad de páginas
    .select-reading = Seleccionar lectura
    .page = Página { $page }
    .unread = sin leer
    .visits = { $count ->
        [one] { $count } visita
    ...
    .of = de { $total }
    .pages-read = páginas leídas
    .no-data = No hay datos de lectura a nivel de página disponibles para este elemento.
    .legend-bookmark = Marcador
    .legend-chapter = Capítulo
    .info = Los números de página se ven afectados por las opciones de formato actuales del documento. A diferencia de otras partes de KoShelf, esta vista no admite el escalado sintético de páginas.
