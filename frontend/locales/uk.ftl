...
collections-empty = Колекцій ще немає
...
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Поточний: за номером сторінки за зростанням
    .page-descending = { sort-order.aria-label-toggle } - Поточний: за номером сторінки за спаданням
previous-month =
...
toast-update-item-error = Не вдалося зберегти зміни
    .subtitle = Ваші редагування були скасовані.
toast-update-annotation-error = Не вдалося оновити анотацію
    .subtitle = Ваші зміни були скасовані.
toast-delete-annotation-error = Не вдалося видалити анотацію
    .subtitle = Її було відновлено.
...
notes-book-search-placeholder = Пошук книг…
