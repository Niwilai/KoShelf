...
estimated-time-left = Est. Time Left
...
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Current: Page Number Ascending
    .page-descending = { sort-order.aria-label-toggle } - Current: Page Number Descending
previous-month =
...
notes-book-search-placeholder = Search books…
