...
estimated-time-left = Tempo restante
...
error-state =
    ...
    .go-to-list = Ir para {$collection}
    .crash-title = Algo deu errado
    .crash-description = Ocorreu um erro inesperado ao renderizar esta página.
    .crash-report = Reportar problema

# Navigation and sorting
library-sort =
    .last-opened = Ordem: Último aberto
...
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Atual: Número da página em ordem crescente
    .page-descending = { sort-order.aria-label-toggle } - Atual: Número da página em ordem decrescente
previous-month =
...
toast-update-item-error = Não foi possível guardar as alterações
    .subtitle = As suas edições foram revertidas.
toast-update-annotation-error = Não foi possível atualizar a anotação
    .subtitle = As suas alterações foram revertidas.
toast-delete-annotation-error = Não foi possível eliminar a anotação
    .subtitle = Foi restaurada.
...
notes-book-filter = Filtrar por livro
notes-book-search-placeholder = Pesquisar livros…
