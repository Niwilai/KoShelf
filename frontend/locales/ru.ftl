...
estimated-time-left = Осталось времени
...
library-sort =
    .last-opened = Сортировка: Последнее открытие
    .alphabetical = Сортировка: А–Я
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Текущий: по номеру страницы по возрастанию
    .page-descending = { sort-order.aria-label-toggle } - Текущий: по номеру страницы по убыванию
previous-month =
...
# -----------------------------------
all-notes = Заметки
notes-search-placeholder = Поиск выделений, заметок, книг...
notes-book-filter = Фильтр по книге
notes-book-search-placeholder = Поиск книг…
notes-empty = Аннотации не найдены
notes-empty-hint = Выделения и заметки, добавленные в KOReader, появятся здесь.
