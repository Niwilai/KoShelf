...
sort-order =
    ...
    .page-ascending = { sort-order.aria-label-toggle } - Actuel : Numéro de page croissant
    .page-descending = { sort-order.aria-label-toggle } - Actuel : Numéro de page décroissant
previous-month =
...
notes-book-search-placeholder = Rechercher des livres…
notes-empty = Aucune annotation trouvée
notes-empty-hint = Les surlignages et notes ajoutés dans KOReader apparaîtront ici.

page-activity = Activité des pages
    .select-reading = Sélectionner la lecture
    .page = Page { $page }
    .unread = non lu
    .visits = { $count ->
        [one] { $count } visite
    ...
    .highlights = { $count ->
        [one] { $count } surlignage
       *[other] { $count } surlignages
    }
    .bookmarks = { $count ->
        [one] { $count } signet
       *[other] { $count } signets
    ...
    .of = sur { $total }
    .pages-read = pages lues
    .no-data = Aucune donnée de lecture au niveau des pages n'est disponible pour cet élément.
    .legend-bookmark = Signet
    .legend-chapter = Chapitre
    .info = Les numéros de page sont influencés par les options de formatage actuelles du document. Contrairement aux autres parties de KoShelf, cette vue ne prend pas en charge la mise à l'échelle synthétique des pages.
